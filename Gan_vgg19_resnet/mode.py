...
from dataset import *
from gan_vgg19_resnet import Generator, Discriminator
...
def train(args):
    ...
    while fine_epoch < args.fine_train_epoch:
        ...
        if fine_epoch % 4000 ==0:
            torch.save(generator.state_dict(), './model/gene_%03d.pt'%fine_epoch)
            torch.save(discriminator.state_dict(), './model/discrim_%03d.pt'%fine_epoch)
