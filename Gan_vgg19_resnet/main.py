...
# parser.add_argument("--LR_path", type = str, default = './dataSet/DIV2K_train_LR_bicubic_X4/X4')
# parser.add_argument("--GT_path", type = str, default = './dataSet/DIV2K_train_HR/')
...
# parser.add_argument("--pre_train_epoch", type = int, default = 8000) #default = 400
# parser.add_argument("--fine_train_epoch", type = int, default = 4000)#default = 300
...
parser.add_argument("--adv_coeff", type=float, default=1e-3)
parser.add_argument("--tv_loss_coeff", type=float, default=0.0)
parser.add_argument("--pre_train_epoch", type=int, default=400)
parser.add_argument("--fine_train_epoch", type=int, default=300)
parser.add_argument("--scale", type=int, default=4)
parser.add_argument("--patch_size", type=int, default=24)
parser.add_argument("--feat_layer", type=str, default='relu5_4')
parser.add_argument("--vgg_rescale_coeff", type=float, default=0.006)
